...
import { AddBloodWork } from './components/AddBloodWork';
import { DetailsBloodWork } from './components/DetailsBloodWork';
    ...
    return (
      <Layout>
        <Route exact path='/' component={Home} />
            ...
            <Route path='/detailsbloodwork' component={DetailsBloodWork} />
