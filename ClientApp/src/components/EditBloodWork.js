...
export class EditBloodWork extends Component {
    static displayName = EditBloodWork.name;
    ...
    constructor(props) {
        ...
        super(props);
        this.state = { statusCode: 0, response: [], bloodWorkID: "", dateCreated: "", examDate: "", id: "", resultsDate: "", description: "", hemoglobin: "", hematocrit: "", whiteBloodCellCount: "", redBloodCellCount: "", waiting: false };
